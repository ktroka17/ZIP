...
<div class="wrapper">
<h3 class="heading"> View Inventory </h3>
<br>
<div> <a href='add_inventory2.php' class='btnr'>Add New Inventory</a></div>
<br>
...
if($res)
 ...
 { 
	...
	echo "<td><a href='edit_inventory2.php?id={$row["Inventory_id"]}'class='btnr'>Edit</a></td>";
